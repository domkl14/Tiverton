(function() {
  ...
  socket.on('setDevelopmentCards', function(data) {
    ...
    if (isExpansion) {
      $('#opponent_4_name').text('');
      $('#opponent_5_name').text('');
    }
    $('#opponent_1_dcards').empty();
    $('#opponent_2_dcards').empty();
    $('#opponent_3_dcards').empty();
    if (isExpansion) {
      $('#opponent_4_dcards').empty();
      $('#opponent_5_dcards').empty();
    }
  ...
  $('#roll').click(function() {
    ...
    socket.emit('sendMsgToServer', {message: '------------------------------------------------------------------'});
    var message;
    if (roll == 8 || roll == 11) {
      message = $('#name').val().toUpperCase() + ' rolled an ' + roll;
    } else {
      message = $('#name').val().toUpperCase() + ' rolled a ' + roll;
    }
  ...
  function drawBoard(game) {
    ...
    // Draw ports
    if (isExpansion) {
      drawPortsExpansion(game.locations);
    } else {
   ...
   * Draw ports
   */
  function drawPortsExpansion(locs) {
    ctx.fillStyle = '#643d01'; // wood color
    ...
    ctx.lineTo(locs[0].x - s * COS_30 * 0.4, locs[0].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[0].x - s * COS_30 * 0.5, locs[0].y - s * SIN_30 * 0.3);
    ctx.lineTo(locs[0].x - s * COS_30 * 0.2, locs[0].y + s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[5].x, locs[5].y);
    ctx.lineTo(locs[5].x, locs[5].y - s * 0.4);
    ctx.lineTo(locs[5].x + s * COS_30 * 0.1, locs[5].y - s * SIN_30 * 0.1 - 0.4 * s);
    ctx.lineTo(locs[5].x + s * COS_30 * 0.2, locs[5].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[7].x, locs[7].y);
    ctx.lineTo(locs[7].x, locs[7].y - s * 0.4);
    ctx.lineTo(locs[7].x - s * COS_30 * 0.1, locs[7].y - s * SIN_30 * 0.1 - 0.4 * s);
    ctx.lineTo(locs[7].x - s * COS_30 * 0.2, locs[7].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // 3:1 port (12, 22)
    ctx.beginPath();
    ctx.moveTo(locs[12].x, locs[12].y);
    ctx.lineTo(locs[12].x + s * COS_30 * 0.4, locs[12].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[12].x + s * COS_30 * 0.5, locs[12].y - s * SIN_30 * 0.3);
    ctx.lineTo(locs[12].x + s * COS_30 * 0.2, locs[12].y + s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[22].x, locs[22].y);
    ctx.lineTo(locs[22].x, locs[22].y - s * 0.4);
    ctx.lineTo(locs[22].x - s * COS_30 * 0.1, locs[22].y - s * SIN_30 * 0.1 - 0.4 * s);
    ctx.lineTo(locs[22].x - s * COS_30 * 0.2, locs[22].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // 3:1 port (50, 51)
    ctx.beginPath();
    ctx.moveTo(locs[50].x, locs[50].y);
    ctx.lineTo(locs[50].x + s * COS_30 * 0.4, locs[50].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[50].x + s * COS_30 * 0.4, locs[50].y + s * 0.3);
    ctx.lineTo(locs[50].x, locs[50].y + s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[51].x, locs[51].y);
    ctx.lineTo(locs[51].x + s * COS_30 * 0.4, locs[51].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[51].x + s * COS_30 * 0.4, locs[51].y - s * 0.3);
    ctx.lineTo(locs[51].x, locs[51].y - s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // Brick port (62, 63)
    ctx.beginPath();
    ctx.moveTo(locs[62].x, locs[62].y);
    ctx.lineTo(locs[62].x, locs[62].y + s * 0.4);
    ctx.lineTo(locs[62].x - s * COS_30 * 0.1, locs[62].y + s * SIN_30 * 0.1 + 0.4 * s);
    ctx.lineTo(locs[62].x - s * COS_30 * 0.2, locs[62].y + s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[63].x, locs[63].y);
    ctx.lineTo(locs[63].x + s * COS_30 * 0.4, locs[63].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[63].x + s * COS_30 * 0.5, locs[63].y + s * SIN_30 * 0.3);
    ctx.lineTo(locs[63].x + s * COS_30 * 0.2, locs[63].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // 3:1 port (72, 78)
    ctx.beginPath();
    ctx.moveTo(locs[72].x, locs[72].y);
    ctx.lineTo(locs[72].x + s * COS_30 * 0.4, locs[72].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[72].x + s * COS_30 * 0.4, locs[72].y + s * 0.3);
    ctx.lineTo(locs[72].x, locs[72].y + s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[78].x, locs[78].y);
    ctx.lineTo(locs[78].x + s * COS_30 * 0.4, locs[78].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[78].x + s * COS_30 * 0.4, locs[78].y - s * 0.3);
    ctx.lineTo(locs[78].x, locs[78].y - s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // Wood port (76, 77)
    ctx.beginPath();
    ctx.moveTo(locs[76].x, locs[76].y);
    ctx.lineTo(locs[76].x, locs[76].y + s * 0.4);
    ctx.lineTo(locs[76].x - s * COS_30 * 0.1, locs[76].y + s * SIN_30 * 0.1 + 0.4 * s);
    ctx.lineTo(locs[76].x - s * COS_30 * 0.2, locs[76].y + s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[77].x, locs[77].y);
    ctx.lineTo(locs[77].x + s * COS_30 * 0.4, locs[77].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[77].x + s * COS_30 * 0.5, locs[77].y + s * SIN_30 * 0.3);
    ctx.lineTo(locs[77].x + s * COS_30 * 0.2, locs[77].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // 3:1 port (74, 75)
    ctx.beginPath();
    ctx.moveTo(locs[74].x, locs[74].y);
    ctx.lineTo(locs[74].x - s * COS_30 * 0.4, locs[74].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[74].x - s * COS_30 * 0.5, locs[74].y + s * SIN_30 * 0.3);
    ctx.lineTo(locs[74].x - s * COS_30 * 0.2, locs[74].y - s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[75].x, locs[75].y);
    ctx.lineTo(locs[75].x, locs[75].y + s * 0.4);
    ctx.lineTo(locs[75].x + s * COS_30 * 0.1, locs[75].y + s * SIN_30 * 0.1 + 0.4 * s);
    ctx.lineTo(locs[75].x + s * COS_30 * 0.2, locs[75].y + s * SIN_30 * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // Hay port (54, 66)
    ctx.beginPath();
    ctx.moveTo(locs[54].x, locs[54].y);
    ctx.lineTo(locs[54].x - s * COS_30 * 0.4, locs[54].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[54].x - s * COS_30 * 0.4, locs[54].y + s * 0.3);
    ctx.lineTo(locs[54].x, locs[54].y + s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[66].x, locs[66].y);
    ctx.lineTo(locs[66].x - s * COS_30 * 0.4, locs[66].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[66].x - s * COS_30 * 0.4, locs[66].y - s * 0.3);
    ctx.lineTo(locs[66].x, locs[66].y - s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    ctx.moveTo(locs[39].x, locs[39].y);
    ctx.lineTo(locs[39].x - s * COS_30 * 0.4, locs[39].y + s * SIN_30 * 0.4);
    ctx.lineTo(locs[39].x - s * COS_30 * 0.4, locs[39].y + s * 0.3);
    ctx.lineTo(locs[39].x, locs[39].y + s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(locs[55].x, locs[55].y);
    ctx.lineTo(locs[55].x - s * COS_30 * 0.4, locs[55].y - s * SIN_30 * 0.4);
    ctx.lineTo(locs[55].x - s * COS_30 * 0.4, locs[55].y - s * 0.3);
    ctx.lineTo(locs[55].x, locs[55].y - s * 0.2);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    // 3:1 port (0, 5)
    ctx.save();
    ctx.translate(locs[0].x, locs[0].y);
    ctx.rotate(Math.PI / 3);
    ctx.fillText('3:1', - s * COS_30 * 0.4, s / 2 + 3);
    ctx.restore();
    ...
    // 3:1 port (12, 22)
    ctx.save();
    ctx.translate(locs[12].x, locs[12].y);
    ctx.rotate(-Math.PI / 3);
    ctx.fillText('3:1', s * COS_30 * 0.4, s / 2 + 3);
    ctx.restore();
    ...
    // 3:1 port (50, 51)
    ctx.save();
    ctx.fillText('3:1', locs[50].x + s * COS_30 * 0.4, (locs[50].y + locs[51].y) / 2 + 3);
    ctx.restore();

    // Brick port (62, 63)
    ctx.save();
    ctx.translate(locs[62].x, locs[62].y);
    ctx.rotate(Math.PI / 3);
    ctx.fillStyle = '#aa3311';
    ctx.fillText('BRICK', s * COS_30 * 0.4, s / 2 + 3);
    ctx.restore();
    ...
    // 3:1 port (72, 78)
    ctx.save();
    ctx.fillText('3:1', locs[72].x + s * COS_30 * 0.4, (locs[72].y + locs[78].y) / 2 + 3);
    ctx.restore();

    // Wood port (76, 77)
    ctx.save();
    ctx.translate(locs[76].x, locs[76].y);
    ctx.rotate(Math.PI / 3);
    ctx.fillStyle = '#145214';
    ctx.fillText('WOOD', s * COS_30 * 0.4, s / 2 + 3);
    ctx.restore();
    ...
    // 3:1 port (74, 75)
    ctx.save();
    ctx.translate(locs[75].x, locs[75].y);
    ctx.rotate(-Math.PI / 3);
    ctx.fillText('3:1', - s * COS_30 * 0.4, s / 2 + 3);
    ctx.restore();
    ...
    ctx.save();
    ctx.fillStyle = '#968a1d';
    ctx.fillText('HAY', locs[54].x - s * COS_30 * 0.4, (locs[54].y + locs[66].y) / 2 + 3);
    ctx.restore();

    // Sheep port (39, 53)
    ctx.save();
    ctx.fillStyle = '#6b9023';
    ctx.fillText('SHEEP', locs[39].x - s * COS_30 * 0.4, (locs[39].y + locs[55].y) / 2 + 3);
    ctx.restore();

    // Ore port (27, 28)
    ctx.save();
    ctx.fillStyle = '#666666';
    ctx.fillText('ORE', locs[27].x - s * COS_30 * 0.4, (locs[27].y + locs[28].y) / 2 + 3);
    ctx.restore();
  }
